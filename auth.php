...
.otp-modal-content::before {
    ...
    right: -2px;
    bottom: -2px;
    background: linear-gradient(45deg,rgb(255, 255, 255),rgb(255, 255, 255),rgba(255, 133, 89, 0.37),rgb(85, 66, 60));
    border-radius: 22px;
    z-index: -1;
    background-size: 300% 300%;
    animation: gradientShift 3s ease infinite;
...
<script>
    // Show the modal on page load with a fade-in effect
    ...
    document.getElementById('closeModalBtn').addEventListener('click', function() {
        document.getElementById('successModal').classList.remove('fade-in');
        setTimeout(function() {
            document.getElementById('successModal').style.display = 'none';
        }, 300); // Wait for fade-out effect before hiding modal
    });
